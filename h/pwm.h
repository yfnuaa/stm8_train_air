...
{
    e_speed_off      = 0,
    e_speed_low      = 8,  // 1.2v is supposed the 600 speed 
    e_speed_middle   = 15,  // 1.9v is supposed the 950 speed 
    e_speed_high     = 22,  // 2.7v is the hightest speed allowed, 1200r/min
    e_speed_full     = 30   // 2.7v is the hightest speed allowed, 1200r/min
}; 
